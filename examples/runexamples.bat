...
TimEx .\mitll_dff\mitll_dff.js -d .\definitions\definitions.txt -x
TimEx .\mitll_splitter\mitll_splitter.js -d .\definitions\definitions.txt -x
TimEx .\mitll_or\mitll_or.js -d .\definitions\definitions.txt -x
TimEx .\mitll_and\mitll_and.js -d .\definitions\definitions.txt -x
TimEx .\mitll_xor\mitll_xor.js -d .\definitions\definitions.txt -x
TimEx .\mitll_ndro\mitll_ndro.js -d .\definitions\definitions.txt -x
TimEx .\mitll_ndo\mitll_ndo.js -d .\definitions\definitions.txt -x
TimEx .\mitll_not\mitll_not.js -d .\definitions\definitions.txt -x
