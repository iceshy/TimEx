...
* Modified 8 Nov 2017, L Schindler, SU   *
* Modified 04 Feb 2018, CJ Fourie, SU    *
*   (TimEx support and Bias variable)    *
* Modified 08 Feb 2018, L Schindler, SU  *
* Modified 09 Feb 2018, CJ Fourie, SU    *
******************************************
* Variables
.PARAM bias=1.0
******************************************
...
IB01       0          51         pwl(0      0 5p {0.0000751355*bias})
IB01_rx1   0          12         pwl(0      0 5p {0.000155*bias})
IB01_rx2   0          64         pwl(0      0 5p {0.000175*bias})
IB01_rx3   0          21         pwl(0      0 5p {0.000175*bias})
IB02       0          54         pwl(0      0 5p {0.0000751355*bias})
IB02_tx1   0          29         pwl(0      0 5p {8.2e-005*bias})
IB04       0          73         pwl(0      0 5p {0.000157547*bias})
IB05       0          50         pwl(0      0 5p {0.00018*bias})
L01_rx1    7          6          2e-013
